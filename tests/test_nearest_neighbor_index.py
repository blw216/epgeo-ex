...
class NearestNeighborTest(unittest.TestCase):
    ...
    def test_spatial_example(self):
        """
        This test evaluates the kd-tree index search performance against the
        naive brute force method. It asserts that the two lists of NN values
        generated by each method are equal.
        """
